...
_ps1 setPos (_vehicle modelToWorld [0,0,0]);
_ps1 setParticleParams [   
 "\A3\Data_F\ParticleEffects\Universal\Mud", "", "SpaceObject",   
 1, 10, [0,0.25,-2.5], _vector, 1, 10, 1, 0.2, [0.1, 0.1],   
 [[1, 1, 1 ,1]],   
...
[{ deleteVehicle (_this select 0); }, [_ps1], 14.5] call CBA_fnc_waitAndExecute; 
...
_grad_dust setPos (_vehicle modelToWorld [0,0,0]);
...
[{ deleteVehicle (_this select 0); }, [_grad_dust], 14.5] call CBA_fnc_waitAndExecute; 
